...
export const OpenAiService = async (fala) => {
    ...
    ${fala}
  `;
    const instrucao2 = "Você pode desligar equipamentos, diminuir energia enviada para eles, então responda com no máximo 3 alternativas, curtas, sobre o que o usuario pode fazer, LEMBRE SE que voce tem acesso ao inversor e pode controlar pra onde manda energia";
    try {
