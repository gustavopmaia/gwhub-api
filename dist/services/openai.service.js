...
exports.OpenAiService = exports.userData = void 0;
...
const OpenAiService = async (fala) => {
    const intrucoes = `
...
`;
    const dispositivosStr = exports.userData.dispositivos
        ? exports.userData.dispositivos
            .map((d) => `- ${d.nome}: ${d.quantidade} unidade(s), consumo: ${d.consumo} kWh, prioridade: ${d.prioridade}`)
            .join('\n')
        : 'Nenhum dispositivo informado';
    const horarioPico = exports.userData.horario_pico
        ? `De ${exports.userData.horario_pico.inicio} até ${exports.userData.horario_pico.fim}`
        : 'Não informado';
    const userInfo = `
Dados do usuário:
- Nome: ${exports.userData.nome || 'Não informado'}
- Idade: ${exports.userData.idade || 'Não informado'}
- Horário de pico: ${horarioPico}
- Dispositivos:
${dispositivosStr}
- Energia armazenada: ${exports.userData.energia_armazenada || 'Não informado'} kWh
`;
    const instrucao2 = `
